...
<!--        </svg>-->
      <a @click="$store.dispatch('sidebar/toggleSidebar')" class="border-2 rounded-full border-pink-500 font-bold text-pink-500 px-4 py-3 transition duration-300 ease-in-out hover:bg-pink-500 hover:text-white mr-6">
        🧺
      </a>
